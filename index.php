...
<head>
    ...
    <style>
        ...
        .form-container {
            flex: 1; /* Permitir que el formulario ocupe el espacio restante */
            text-align: center;
        }
        input[type="text"] {
            padding: 10px;
        ...
        .button {
            ...
            height: 160px; /* Alto fijo para ser cuadrados */
        ...
        .button:hover {
            background-color: #505050; /* Color más oscuro al pasar el mouse */
        }
    </style>
    <script>
